 ...
 */
public class SXRTestableActivity extends SXRActivity {
    private static final String TAG = SXRTestableActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        testableMain = new SXRTestableMain();
        setMain(testableMain, "sxr.xml");
    ...
    SXRTestableMain getSXRTestableMain() {
        return testableMain;
    }
